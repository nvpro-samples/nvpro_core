...
int has_VK_KHR_synchronization2 = 0;
int load_VK_KHR_synchronization2(VkInstance instance, PFN_vkGetInstanceProcAddr getInstanceProcAddr, VkDevice device, PFN_vkGetDeviceProcAddr getDeviceProcAddr)
{
  ...
  int success = 1;
  success = success && (pfn_vkCmdSetEvent2KHR != 0);
  success = success && (pfn_vkCmdResetEvent2KHR != 0);
  success = success && (pfn_vkCmdWaitEvents2KHR != 0);
  success = success && (pfn_vkCmdPipelineBarrier2KHR != 0);
  success = success && (pfn_vkCmdWriteTimestamp2KHR != 0);
  success = success && (pfn_vkQueueSubmit2KHR != 0);
  success = success && (pfn_vkCmdWriteBufferMarker2AMD != 0);
  success = success && (pfn_vkGetQueueCheckpointData2NV != 0);
  has_VK_KHR_synchronization2 = success;
  return success;
}
#endif
...
void load_VK_EXTENSION_SUBSET(VkInstance instance, PFN_vkGetInstanceProcAddr getInstanceProcAddr, VkDevice device, PFN_vkGetDeviceProcAddr getDeviceProcAddr) {
  ...
  #endif
  #if VK_KHR_synchronization2
  load_VK_KHR_synchronization2(instance, getInstanceProcAddr, device, getDeviceProcAddr);
  #endif
}
void reset_VK_EXTENSION_SUBSET() {
  ...
  #if VK_KHR_synchronization2
  has_VK_KHR_synchronization2 = 0;
  PFN_vkCmdSetEvent2KHR pfn_vkCmdSetEvent2KHR = 0;
  PFN_vkCmdResetEvent2KHR pfn_vkCmdResetEvent2KHR = 0;
  PFN_vkCmdWaitEvents2KHR pfn_vkCmdWaitEvents2KHR = 0;
  PFN_vkCmdPipelineBarrier2KHR pfn_vkCmdPipelineBarrier2KHR = 0;
  PFN_vkCmdWriteTimestamp2KHR pfn_vkCmdWriteTimestamp2KHR = 0;
  PFN_vkQueueSubmit2KHR pfn_vkQueueSubmit2KHR = 0;
  PFN_vkCmdWriteBufferMarker2AMD pfn_vkCmdWriteBufferMarker2AMD = 0;
  PFN_vkGetQueueCheckpointData2NV pfn_vkGetQueueCheckpointData2NV = 0;
  #endif
