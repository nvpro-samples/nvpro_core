...
int has_VK_KHR_deferred_host_operations = 0;
int load_VK_KHR_deferred_host_operations(VkInstance instance, PFN_vkGetInstanceProcAddr getInstanceProcAddr, VkDevice device, PFN_vkGetDeviceProcAddr getDeviceProcAddr)
{
  ...
  int success = 1;
  success = success && (pfn_vkCreateDeferredOperationKHR != 0);
  success = success && (pfn_vkDestroyDeferredOperationKHR != 0);
  success = success && (pfn_vkGetDeferredOperationMaxConcurrencyKHR != 0);
  success = success && (pfn_vkGetDeferredOperationResultKHR != 0);
  success = success && (pfn_vkDeferredOperationJoinKHR != 0);
  has_VK_KHR_deferred_host_operations = success;
  return success;
}
#endif
...
void load_VK_EXTENSION_SUBSET(VkInstance instance, PFN_vkGetInstanceProcAddr getInstanceProcAddr, VkDevice device, PFN_vkGetDeviceProcAddr getDeviceProcAddr) {
  ...
  #endif
  #if VK_KHR_deferred_host_operations
  load_VK_KHR_deferred_host_operations(instance, getInstanceProcAddr, device, getDeviceProcAddr);
  #endif
  #if VK_KHR_pipeline_executable_properties
...
void reset_VK_EXTENSION_SUBSET() {
  ...
  #if VK_KHR_deferred_host_operations
  has_VK_KHR_deferred_host_operations = 0;
  PFN_vkCreateDeferredOperationKHR pfn_vkCreateDeferredOperationKHR = 0;
  PFN_vkDestroyDeferredOperationKHR pfn_vkDestroyDeferredOperationKHR = 0;
  PFN_vkGetDeferredOperationMaxConcurrencyKHR pfn_vkGetDeferredOperationMaxConcurrencyKHR = 0;
  PFN_vkGetDeferredOperationResultKHR pfn_vkGetDeferredOperationResultKHR = 0;
  PFN_vkDeferredOperationJoinKHR pfn_vkDeferredOperationJoinKHR = 0;
  #endif
