...
# download_files(FILENAMES zlib.zip EXTRACT TARGET_DIR ${BASE_DIRECTORY}/shared_external SOURCE_DIR libraries NOINSTALL) 
# 
function(download_files)
  ...
  if(NOT DEFINED DOWNLOAD_FILES_SOURCE_DIR)
    set(DOWNLOAD_FILES_SOURCE_DIR "scenes")
  endif()
  ...
  foreach(FILENAME ${DOWNLOAD_FILES_FILENAMES})
    ...
    if(NOT EXISTS ${TARGET_FILENAME})
      ...
      file(DOWNLOAD ${DOWNLOAD_SITE}/${FILENAME} ${TARGET_FILENAME} SHOW_PROGRESS)
